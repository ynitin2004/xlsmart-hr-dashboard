  ...
  const handleAnalysis = async () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke('ai-advanced-role-intelligence', {
        body: { analysisType: selectedAnalysis }
      });
          ...
          {selectedAnalysis === 'role_evolution' && results.evolutionOverview && (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="text-2xl font-bold">{Math.round(results.evolutionOverview.evolutionRate * 100)}%</div>
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="text-2xl font-bold">{Math.round(results.evolutionOverview.adaptationReadiness * 100)}%</div>
          ...
          {selectedAnalysis === 'redundancy_analysis' && results.redundancyOverview && (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="text-2xl font-bold">{Math.round(results.redundancyOverview.overlapScore * 100)}%</div>
                    <div className="text-sm text-muted-foreground">Overlap Score</div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4">
                    <div className="text-2xl font-bold">{Math.round(results.redundancyOverview.optimizationPotential * 100)}%</div>
          ...
          {selectedAnalysis === 'competitiveness_scoring' && results.competitivenessOverview && (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card>
                  <CardContent className="p-4">
                    <div className="text-2xl font-bold">{Math.round(results.competitivenessOverview.averageCompetitivenessScore * 100)}%</div>
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="text-2xl font-bold">{Math.round(results.competitivenessOverview.retentionAdvantage * 100)}%</div>
...
export const AIAdvancedRoleIntelligenceOptimized = AIAdvancedRoleIntelligence;